...
public class DateBot
{
    ...
    public HashSet<Long> getAbledUsers()
    {
        return abledUsers;
    }

    public  HashMap<Long, Questionary> getQuestionaries()
    {
        return questionaries;
    }

    public HashMap<Long, State> getStates()
    {
        return states;
    }

    public HashMap<Long, Long> getConnections()
    {
        return connections;
    }
    ...
    private BotResult processCommands(Long chatId, String text)
    {
        ...
        switch (text)
        {
            ...
            case "/disable":
                ...
                result.addText("Now no one can write you");
                break;
            case "/connect":
